...
% Relevant variables
step = 0.001 ; % Time step [s]
end_time = 27 ; % Simulation time [s]
file_name = "3body_2d_data.csv" ; % Output data file name
...
data = table(x1, y1, x2, y2, x3, y3, vx1, vy1, vx2, vy2, vx3, vy3);


% write data !!!!!!!
writetable(data, file_name, "WriteRowNames", false, "WriteVariableNames", false)
